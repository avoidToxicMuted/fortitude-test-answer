...
class JumbleEngineTest {
    ...
    @Test
    void whenInvalidWord_thenEmptyList() throws GoodQuestionException {
    ...
    @Test
    void whenValidWord_thenSomeWord() throws GoodQuestionException {
    ...
    @Test
    void givenValidInput_whenCreateGameState_thenExpectSuccess() throws GoodQuestionException {
