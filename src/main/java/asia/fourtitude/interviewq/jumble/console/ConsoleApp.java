...
public class ConsoleApp extends AConsole {
    ...
    private void generateSubWords() throws GoodQuestionException {
        cout.println();
    ...
    public void run() throws GoodQuestionException {
        boolean exit = false;
    ...
    public static void main(String[] args) throws GoodQuestionException {
